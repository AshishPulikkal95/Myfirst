...
"""
------------------------SVM MODEL(KERNEL = GUSSIAN)-----------------------------------
Confusion Matrix shows that Gaussian Kernel has better accuracy than Linear kernel SVM
"""
#---------------------------SVM Model-------------------------------
...
Conf_Matrix_Gaussian = confusion_matrix(Y_test, Y_pred)
...
from sklearn.svm import SVC 
svm_cls = SVC(kernel = 'linear') #can use randome_state too 
svm_cls.fit(X_train, Y_train)
